...
checkbox.addEventListener("click", activarCheckbox);

function activarCheckbox() {
    let precioOriginal = document.querySelector("#precio-original");
    precioOriginal.classList.toggle("mostrar-precio-original")
}
...
function mostrarTabla(){
    ...
    for (const i of productos) {
            if(i.precio != ""){
                claseEspecial = "fondo-oferta";
            }else{
                claseEspecial = "";
            }
            document.querySelector(".show").innerHTML += `<tr class="${claseEspecial}">
